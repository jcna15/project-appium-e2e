...
public class RedmineHomePage extends com.company.projectappiume2e.pages.RedmineLoginPage {

    private By menuMyPage = By.xpath("//a[@href='/redmine/my/page'");
    private By menuProjects = By.xpath("//a[@href='/redmine/projects']");
    private By menuAdmin = By.xpath("//a[@href='/redmine/admin']");
