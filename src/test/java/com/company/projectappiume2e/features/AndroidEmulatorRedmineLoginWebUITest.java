...
public class AndroidEmulatorRedmineLoginWebUITest extends BaseTest {
    ...
    public void testLoginRedmineEmulatorNexus5Android7(){
        ...
        cap.setCapability("chromedriverExecutableDir","D:\\Java Projects\\project-appium-e2e\\resources\\drivers\\chrome\\Win");
    ...
    @Test
    public void testLoginRedmineEmulatorNexus5Android30(){
        DesiredCapabilities cap = new DesiredCapabilities();
        cap.setCapability("automationName", "UiAutomator2");
        cap.setCapability("platformName", "Android");
        ...
        assertEquals("jnavarro", redmineHomePage.getUserLoggedMobileEmulation());
    }
}
